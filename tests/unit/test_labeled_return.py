...
class TestParseYoloTxt:
    def test_standard_5col(self, tmp_path):
        """标准 5 列格式正常解析。"""
        from labeling.labeled_return import parse_yolo_txt
...
class TestBoxIouNorm:
    def test_perfect_overlap(self):
        """完全重叠，IoU = 1.0。"""
        from labeling.labeled_return import _box_iou_norm
...
class TestMatchPairs:
    def test_perfect_match(self):
        """一一对应完全匹配。"""
        from labeling.labeled_return import _match_pairs
...
class TestCompareOneImage:
    def test_perfect_consistency(self):
        ...
        from labeling.labeled_return import compare_one_image
